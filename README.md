...
<h3 align="center">
  Software Engineer | Full Stack Developer | Machine Learning | GenAI | DSA
</h3>

<p align="left">
  <img src="https://komarev.com/ghpvc/?username=Official-Vinit&label=Profile%20views&color=0e75b6&style=flat" alt="Profile Views" />
</p>
...
- 💻 Full Stack Developer with strong experience in the **MERN stack**
- 🤖 Working with **Machine Learning, GenAI, LLMs, RAG, LangChain, Transformers, and OpenAI APIs**
- 🚀 Built and deployed full-stack applications using **React, Node.js, Express, MongoDB, Vercel, Render, and AWS**
- 🧠 Strong in **DSA**, with **250+ LeetCode problems** and **5-star Problem Solving on HackerRank**
- 👯 Open to collaborating on **Software Development, AI/ML, GenAI, and MERN projects**
- 💬 Ask me about **MERN Stack, Machine Learning, GenAI, RAG, System Design, DSA, and Android Development**
- 📫 Reach me at: **officialvinit1176@gmail.com**
- 😄 Pronouns: **He/Him**
...
### CDC - Placement Cell Management System  
- MERN-based placement cell management platform  
- Implemented **JWT authentication** and **role-based access control** for admin and students  
- Added file upload functionality using **Cloudinary** for resume and document management  

🔗 GitHub: [CDCWork](https://github.com/Official-Vinit/CDCWork)

---

### BhindiOnline - Real-Time Chat Platform  
- Built a full-stack chat platform using **React, Redux Toolkit, Tailwind CSS, Node.js, Express, MongoDB, and Socket.IO**
- Implemented **JWT authentication**, **HTTP-only cookies**, **bcrypt password hashing**, and protected routes
- Added profile/image upload using **Multer + Cloudinary**
- Integrated real-time online presence and live message delivery  

🔗 GitHub: [BhindiOnline](https://github.com/Official-Vinit/bhindiOnline.git)

---

### RAG Integration with LLMs  
- Built a RAG pipeline using **OpenAI, Groq, LangChain, ChromaDB, and LLMs**
- Implemented semantic search with cosine-similarity-based ranking
- Created a custom vector store manager for document embedding storage and retrieval  

🔗 GitHub: [RAGwithLLMPipeline](https://github.com/Official-Vinit/RAGwithLLMPipeline.git)

---

### Text Summarizer using T5  
- Trained a text summarization model using **Google T5-small**
- Used **4000 samples for training** and **350 samples for validation**
- Trained for **6 epochs** to improve summarization accuracy  

🔗 GitHub: [TextSummarizer](https://github.com/Official-Vinit/TextSummarizer.git)
...
- ☁️ AWS Academy Cloud Foundations Certificate
...
<p>
  <img align="center" src="https://github-readme-stats.vercel.app/api?username=Official-Vinit&show_icons=true&locale=en" alt="GitHub Stats" />
</p>

<p>
  <img align="center" src="https://github-readme-stats.vercel.app/api/top-langs?username=Official-Vinit&show_icons=true&locale=en&layout=compact" alt="Top Languages" />
</p>

<p>
  <img align="center" src="https://github-readme-streak-stats.herokuapp.com/?user=Official-Vinit" alt="GitHub Streak" />
</p>
...
- GenAI, RAG, and LLM-based Applications  
- DSA and Problem Solving  
- Cloud Deployment using AWS, Render, and Vercel  
